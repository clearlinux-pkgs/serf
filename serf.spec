...
# Using build pattern: scons
# autospec version: v3
# autospec commit: ab27b0e7ad12
#
# Source0 file verified with key 0xB64FFF1209F9FA74 (evgeny.kotkov@visualsvn.com)
#
Name     : serf
Version  : 1.3.10
Release  : 18
...
Source1  : https://archive.apache.org/dist/serf/serf-1.3.10.tar.bz2.asc
...
%prep
%setup -q -n serf-1.3.10
cd %{_builddir}/serf-1.3.10
%patch -P 1 -p1
